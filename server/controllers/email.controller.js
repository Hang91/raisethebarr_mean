...
// create reusable transporter object using the default SMTP transport
    let transporter = nodemailer.createTransport({
        service: 'gmail',
        auth: {
            user: 'sender_email@gmail.com', // generated ethereal user
            pass: 'sender_passwd' // generated ethereal password
        }
    });

    // setup email data with unicode symbols
    let mailOption1 = {
        from: '"Raise the Barr" <sender_email@gmail.com>', // sender address
    ...
    let mailOption2 = {
        from: '"Raise the Barr" <sender_email@gmail.com>', // sender address
        to: 'receiver_email', // manager address
...
function sendEmailContact(req, res, next) {
    ...
    let mailOption2 = {
        from: '"Raise the Barr" <sender_email@gmail.com>', // sender address
        to: 'receiver_email@hotmail.com', // manager address
